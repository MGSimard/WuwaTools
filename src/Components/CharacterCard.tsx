  ...
  return (
    <div className={"character-card glass"}>
      <div className={`cc-portrait-container ${character.rarity ? "cc-r" + character.rarity : null}`}>
        <img className="cc-portrait" src={`/images/characters/${character.image.portrait}`} alt="" />
        <img className="cc-attribute" src={`/images/attributes/${character.attribute}.png`} alt="" />
      </div>
